...
BitCampus is currently deployed on Vercel as a static frontend prototype.
...
> **Note:** Both links point to the frontend-only BitCampus prototype. The current authentication, data persistence, Smart Layer, and BitAI features run in the browser using JavaScript, `localStorage`, and `sessionStorage`.
...
For the latest live preview, use the **Primary Demo** listed near the top of this README.
